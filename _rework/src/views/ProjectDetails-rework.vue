    ...
    <div class="row row-details">
      <div class="col-md-3 col-left">
        <div class="card insights-card">
          <div class="card-header">
            ...
            <p><b>Project Team</b> <br>Project Team Members </p>
            <p>
              <button v-if="requestUser == project.pm_email" @click="rejectCandidate()" class="btn-insights red">Reject Candidate</button>
              <button v-if="requestPosition == 'Coder' && project.phase == 'proposed'" @click="joinTeam()" class="btn-insights green">Join Team</button>
            </p>
          </div>
          <div class="row-image">
        ...
        <div class="card insights-card">
          <div class="card-header">
            ...
            <p><b>Project Log</b> <br>Project Messages List </p>
          </div>
          <div class="row-image">
      ...
      <div class="col-md-6 col-center">
        <div class="card insights-card">
          <div class="card-header">
            <img src="@/assets/img/team.png" class="img-responsive">
            <p><b>Project Team Requirements</b> <br>Skillset required to launch the project </p>
          </div>
          <div class="row-image">
