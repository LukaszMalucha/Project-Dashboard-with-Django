...
class PersonalityTests(TestCase):
    ...
    def test_socializer_answers(self):
        answers = ["answer_1" for i in range(6)]
        personality = pt(answers)

        self.assertEqual(personality , "socializer")

    def test_achiever_answers(self):
        answers = ["answer_2" for i in range(6)]
        personality = pt(answers)

        self.assertEqual(personality , "achiever")
    ...
    def test_explorer_answers(self):
        answers = ["answer_4" for i in range(6)]
        personality = pt(answers)

        self.assertEqual(personality , "explorer")