<template>
  <div class="row plain-element">
    <div class="row header details-header">
      ...
      <div class="col-md-9 col-lg-9 text-left plain-element">
        <div class="box box-details" v-if="project">
          ...
          <button v-if="requestPosition == 'admin' && project.phase == 'deployment'"
        ...
        <table class="profile-details">
          ...
          <tr>
            <td>Budget: &nbsp;</td>
            <td><b><img src="https://project-gamification.s3-eu-west-1.amazonaws.com/static/img/leancoin.png" class="icon"> {{ project.budget }}</b></td>
          </tr>
          <tr>
            <td>Phase:</td>
        ...
        <div class="col-md-6 col-left plain-element">
          ...
          <div class="row plain-element">
            <div class="col-md-12 plain-element">
              <div v-if="project.phase == 'proposed'" class="card insights-card">
